...
?>
    ...
    <div id="bloqueio-conteudo" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); z-index: 1060; display: flex; align-items: center; justify-content: center;">
        <div class="modal fade show" id="primeiroAcessoModal" tabindex="-1" aria-labelledby="primeiroAcessoModalLabel" aria-modal="true" role="dialog" style="display: block;">
            <div class="modal-dialog modal-dialog-centered"><div class="modal-content shadow-lg border-0 rounded-3"><div class="modal-header bg-primary text-white border-0 rounded-top-3"><h5 class="modal-title" id="primeiroAcessoModalLabel"><i class="fas fa-shield-alt me-2"></i>Primeiro Acesso - Redefinir Senha</h5></div><div class="modal-body p-4"><p class="text-muted mb-4">Por segurança, defina uma nova senha segura.</p><form id="formRedefinirSenha" novalidate><input type="hidden" name="csrf_token_modal" value="<?= htmlspecialchars($csrf_token ?? '') ?>"><div class="mb-3 position-relative"><label for="nova_senha_modal" class="form-label small fw-semibold">Nova Senha</label><input type="password" class="form-control form-control-sm" id="nova_senha_modal" name="nova_senha" required minlength="8" aria-describedby="novaSenhaHelp"><div id="novaSenhaHelp" class="form-text small mt-1">Mínimo 8 caracteres, maiúscula, minúscula e número.</div><div class="invalid-feedback small">Senha inválida.</div></div><div class="mb-3 position-relative"><label for="confirmar_senha_modal" class="form-label small fw-semibold">Confirmar Nova Senha</label><input type="password" class="form-control form-control-sm" id="confirmar_senha_modal" name="confirmar_senha" required><div class="invalid-feedback small">As senhas não coincidem.</div></div><div id="senha_error" class="alert alert-danger alert-sm mt-3 p-2 small d-flex align-items-center" style="display: none;" role="alert"><i class="fas fa-exclamation-triangle me-2"></i><span id="senha_error_text"></span></div><div id="senha_sucesso" class="alert alert-success alert-sm mt-3 p-2 small d-flex align-items-center" style="display: none;" role="alert"><i class="fas fa-check-circle me-2"></i><span id="senha_sucesso_text">Senha redefinida! Atualizando...</span></div><button type="submit" class="btn btn-primary w-100 mt-4 fw-semibold"><i class="fas fa-key me-2"></i>Redefinir Senha</button></form></div></div></div>
        </div>
    </div>
    <?php else: ?>
